  ...
  return (
    <div className="group relative h-[420px] rounded-[32px] overflow-hidden border border-white/5 bg-[#050505] transition-all hover:border-cyan-400/30 hover:shadow-[0_45px_90px_rgba(0,0,0,0.8)] flex flex-col">
       ...
       <div className="relative z-10 p-8 flex-1 flex flex-col justify-between">
          ...
          <Link 
            to={to} 
            className="mt-8 flex items-center justify-center gap-3 w-full py-5 rounded-2xl border border-white/5 bg-white/2 text-[10px] font-black uppercase tracking-widest text-[#555] hover:bg-cyan-400 hover:text-black hover:border-cyan-400 transition-all duration-300 group/btn"
          >
