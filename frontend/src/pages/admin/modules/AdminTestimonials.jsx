      ...
      <div className="grid lg:grid-cols-[380px_1fr] gap-16">
          ...
          <div className="space-y-4 max-h-[800px] overflow-y-auto pr-4 custom-scrollbar">
            {filteredItems.map(item => (
              ...
              >
                ...
                <div className="w-16 h-16 rounded-2xl overflow-hidden flex-shrink-0 border border-white/10 shadow-xl transition-transform duration-500">
                  <img 
        ...
        <div className="space-y-16 animate-in fade-in slide-in-from-right-4 duration-700">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-white/[0.05] pb-12">
            <div>
               <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase mb-2">{selectedId ? "Refine Review" : "Initialize New Record"}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-2">
              <label className={labelClasses}><User size={12} className="text-cyan-400" /> Professional Identity (EN)</label>
          ...
          <div className="space-y-10">
            <div className="space-y-2">
               <label className={labelClasses}><Quote size={12} className="text-cyan-400" /> Professional Endorsement (EN)</label>
